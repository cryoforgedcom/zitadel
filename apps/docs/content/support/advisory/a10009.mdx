...
description: "A-10009: Zitadel now requires CockroachDB with enabledurablelockingforserializable flag for distributed locking on FOR UPDATE statements in v2.53.0"
---
