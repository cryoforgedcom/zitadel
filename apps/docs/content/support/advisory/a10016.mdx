...
description: "A-10016: Precision bug fix affects compare operations in projections due to changes in eventstore position handling in Zitadel v2.65.x-v3.2.1"
---
