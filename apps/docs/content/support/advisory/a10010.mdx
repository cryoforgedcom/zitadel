...
description: "A-10010: The creation of user tokens now generates 'user.token.v2.added' events in Zitadel v2.53.0 instead of 'user.token.added' for audit log consistency"
---
