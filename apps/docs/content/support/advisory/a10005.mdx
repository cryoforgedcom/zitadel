...
description: "A-10005: Renaming eventstore.events table causes downtime during setup in Zitadel v2.39.0 due to storage optimizations for events migration"
---
