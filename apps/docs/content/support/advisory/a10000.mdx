...
description: "A-10000: Zitadel's default login behavior changed to auto-authenticate with one active session in v2.32.0 affecting account selection prompts"
---
