...
description: "Common troubleshooting steps for Zitadel, including error messages, login issues, and community support resources."
sidebar_label: Troubleshoot
---

You will find some possible error messages here, what the problem is and what some possible solutions can be.

<Callout title="Didn't find an answer?  ">
...
![Same Site Strict Enforcement](../../public/img/manuals/errors/same-site-strict.png)

**Settings > Safari > disable: "Block All cookies"**
![](../../public/img/manuals/errors/block-cookies.png)
...
![](../../public/img/support/login_not_possible_error.png)
...
![](../../public/img/support/project_grant_missing.png)
...
![](../../public/img/support/check_for_project_on_authentication.png)
...
![](../../public/img/support/project_grant_for_customer_b.png)
