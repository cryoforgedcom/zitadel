...
description: "Zitadel security and technical advisories, including important updates, vulnerability disclosures, and required configuration changes."
...
<table>
  ...
  <tr>
    ...
    <td>Increased transaction duration for projections</td>
    <td>Breaking Behavior Change</td>
    <td>
...
As Zitadel Cloud customer, you can also log in to the <a href="https://zitadel.com/admin">Zitadel Customer Portal</a> and enable the Technical Advisory <a href="https://zitadel.com/admin/settings">Notifications</a> in your settings.
