---
title: "Hosted Login UI: Authenticate Your Users"
description: "Securely authenticate users via Zitadel's hosted Single Sign-On (SSO) login page, supporting OIDC and SAML protocols."
...
![Screenshot of Zitadel management console showing different identity provider templates](../../../../public/img/guides/integrate/login/login-external-idp-templates.png)
...
<Callout type="warning" title="Customizing texts in Hosted Login V2">
...
<Callout title="Disabling multifactor prompt">
...
We have worked on a new, self-hostable implementation of our hosted MIT licensed login built with Next.js and leveraging our [Session API](/guides/integrate/login/login-users#zitadels-session-api).
...
<Tabs 
    groupId="deployment" 
    defaultIndex={0} 
    items={['Activate Zitadel Cloud V2 Login', 'Vercel Custom Login Deployment']}
>
    <Tab value="Activate Zitadel Cloud V2 Login">
        ...
        ![](../../../../public/img/guides/integrate/login/login-v2-app-config.png)
    ...
    <Tab value="Vercel Custom Login Deployment">
