---
title: "OpenID Connect (OIDC) Authentication: Authorization Code Flow & PKCE guide"
description: "Step-by-step guide to authenticating users in your application using OpenID Connect (OIDC). Learn how to implement the Authorization Code flow with PKCE for maximum security."
sidebar_label: OIDC Authorization Code Flow + PKCE
---
...
![](../../../../../public/img/guides/auth_flow.png)
...
<Tabs
    groupId="app-type"
    defaultIndex={0}
    items={['Web Application','Native Application','Single Page Application']}
>
...
<AuthMethods components={props.components}  selected="web" />
</Tab>

<Tab value="Native Application">

#### Authentication method

When selecting Native the authentication method always needs to be PKCE.

<AuthMethods components={props.components}  selected="native" />
</Tab>

<Tab value="Single Page Application">
...
<AuthMethods components={props.components}  selected="spa" />
</Tab>
</Tabs>
