...
description: "Overview of recommended OIDC and OAuth 2.x authorization flows for secure user authentication and resource access"
...
![](../../../../../public/img/guides/consulting_federated_identities_basics.png)
