---
title: User Authentication Options with Zitadel
description: "Overview of authentication protocols supported by Zitadel, including OpenID Connect and SAML, for unified user login."
...
![](../../../../public/img/guides/integrate/login/login-start.png)
...
<Callout title="Session API support for OIDC and SAML">
