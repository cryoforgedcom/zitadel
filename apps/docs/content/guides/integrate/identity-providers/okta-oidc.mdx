...
description: "Configure OKTA as an OIDC Identity Provider in Zitadel by registering a new client and adding it to your login policy"
...
![](../../../../public/img/guides/okta_add_app.png)
...
![](../../../../public/img/guides/zitadel_activate_okta.png)
