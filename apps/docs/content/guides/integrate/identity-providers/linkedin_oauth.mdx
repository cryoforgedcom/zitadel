---
title: LinkedIn OAuth Identity Provider in Zitadel
...
![](../../../../public/img/guides/linkedin_add_app.png)
...
<GenericOAuth components={props.components}
    name=": e.g. LinkedIn"
...
![](../../../../public/img/guides/zitadel_linkedin_create_provider.png)

### Activate IdP

<Activate components={props.components} />

![](../../../../public/img/guides/zitadel_activate_linkedin.png)

## Test the setup

<TestSetup components={props.components}  loginscreen="your LinkedIn login"/>

![](../../../../public/img/guides/zitadel_login_linkedin.png)

![](../../../../public/img/guides/linkedin_login.png)
