---
title: OpenLDAP Identity Provider Setup in Zitadel
description: "Configure a local OpenLDAP server as an Identity Provider in Zitadel to authenticate users with custom credentials"
...
<Intro components={props.components}  provider="a local OpenLDAP server"/>
