...
description: "Enable SAML 2.0 Single Sign-On for AWS IAM Identity Center (formerly AWS SSO) using Zitadel as the identity provider."
...
1. Chose the External identity provider:
   ![](../../../../public/img/saml/aws/change_idp.png)
...
3. Fill out the fields as follows, to provide AWS with all the information it needs:
   ![](../../../../public/img/saml/aws/configure_idp.png)
