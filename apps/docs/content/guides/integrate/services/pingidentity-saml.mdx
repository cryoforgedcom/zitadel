...
description: "Configure SAML 2.0 connection between Ping Identity and Zitadel to enable login with Zitadel on Ping Identity"
...
1. As described you have to create a new provider, with a unique identifier:
   ![](../../../../public/img/saml/pingidentity/create_idp_profile.png)

We recommend activating signing the auth request whenever possible:
![](../../../../public/img/saml/pingidentity/conf_connection.png)
...
- Import certificate, provided from the certificate endpoint
  ![](../../../../public/img/saml/pingidentity/conf_idp_connection.png)
...
![](../../../../public/img/saml/pingidentity/idp_p1_connection.png)
![](../../../../public/img/saml/pingidentity/idp_idp_configuration.png)
