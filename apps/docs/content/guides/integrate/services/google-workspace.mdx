...
description: "Configure Zitadel as the SAML 2.0 Identity Provider (IdP) for Single Sign-On (SSO) in Google Workspace."
...
![](../../../../public/img/guides/integrate/services/google-workspace-sso-overview.png)
...
![](../../../../public/img/guides/integrate/services/google-workspace-domain-sepcific-urls.png)

Save the settings.

![](../../../../public/img/guides/integrate/services/google-workspace-sso-bottom.png)
...
![](../../../../public/img/guides/integrate/services/google-workspace-sso-zitadel.png)

You can copy the "Entity ID" and "ACS URL" from the "SP details" section.

![](../../../../public/img/guides/integrate/services/google-workspace-zitadel-profile-configured.png)
...
![](../../../../public/img/guides/integrate/services/google-workspace-zitadel-set-profile.png)
