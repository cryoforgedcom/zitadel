...
description: "Configure a SAML 2.0 connection between Auth0 and Zitadel to enable login with Zitadel on Auth0 using enterprise connections"
...
![](../../../../public/img/saml/auth0/auth_enterprise.png)

1. Press the "+" button right to "SAML"
   ![](../../../../public/img/saml/auth0/enterprise_connections.png)
2. Fill out the fields as follows in the SAML Connection:
   ![](../../../../public/img/saml/auth0/connection.png)
...
![](../../../../public/img/saml/auth0/auth_enterprise_try.png)
