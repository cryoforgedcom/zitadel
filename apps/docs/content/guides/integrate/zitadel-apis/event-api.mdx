...
description: "Consume and query audit logs and system changes via Zitadel's Event API for integration, monitoring, and reporting."
...
You need to assign a user the [administrator role](/guides/manage/console/administrators) IAM_OWNER_VIEWER or IAM_OWNER to access the Event API.
