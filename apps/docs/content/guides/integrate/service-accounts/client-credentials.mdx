---
title: OAuth Client Credentials for Service Accounts
description: "Authenticate service accounts using the industry-standard OAuth 2.0 Client Credentials flow."
...
![](../../../../public/img/console_service_account_tokentype.png)
