---
title: Personal Access Token Auth for Service Accounts
description: "Generate and manage Personal Access Tokens (PAT) for service accounts to enable non-interactive API access to Zitadel."
...
![](../../../../public/img/guides/console-service-user-pat.gif)
...
![](../../../../public/img/guides/console-service-user-org-owner.gif)
