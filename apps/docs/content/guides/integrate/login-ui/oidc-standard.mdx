---
title: OpenID Connect (OIDC) in Custom Login UI
description: "Support for the full OpenID Connect (OIDC) standard when building a custom login UI with Zitadel."
...
![](../../../../public/img/guides/login-ui/oidc-flow.png)
