...
description: "Support multi-factor authentication (MFA) methods like TOTP, SMS, and WebAuthn in your custom login UI."
...
![](../../../../public/img/guides/login-ui/register-totp-flow.png)

### List the Possible Methods

<MfaOptions components={props.components} />
...
![](../../../../public/img/guides/login-ui/authenticate-totp-flow.png)
...
![](../../../../public/img/guides/login-ui/register-phone-otp-flow.png)
...
![](../../../../public/img/guides/login-ui/authenticate-phone-otp-flow.png)
...
![](../../../../public/img/guides/login-ui/register-email-otp-flow.png)
...
![](../../../../public/img/guides/login-ui/authenticate-email-otp-flow.png)
...
![](../../../../public/img/guides/login-ui/register-u2f-flow.png)
...
<BrowserRegisterWebAuthN components={props.components} />
...
![](../../../../public/img/guides/login-ui/authenticate-u2f-flow.png)
...
<BrowserSigninWebAuthN components={props.components} />

### Update Session with WebAuthN

<UpdateSessionWebAuthN components={props.components} />
