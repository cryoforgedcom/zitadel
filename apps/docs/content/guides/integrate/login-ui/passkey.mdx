...
description: "Register and verify a Passkey with Zitadel to enable phishing-resistant authentication using the FIDO Standard protocol"
...
![](../../../../public/img/guides/login-ui/passkey-registration-flow.png)
...
![](../../../../public/img/guides/login-ui/passkey-login-flow.png)
