...
description: "Request a password reset and send a verification code via Zitadel or custom channel to users who forgot their passwords"
...
![](../../../../public/img/guides/login-ui/password-reset-flow.png)
