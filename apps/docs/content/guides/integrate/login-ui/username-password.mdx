---
title: Username & Password Login in Custom Login UI
description: "Create a new user with profile data and verify their email address using Zitadel's registration flow"
...
![](../../../../public/img/guides/login-ui/username-password-flow.png)
