...
description: "Proxy SAML requests from a custom login UI to the Zitadel API for authentication with external applications"
...
![](../../../../public/img/guides/login-ui/saml-flow.png)
...
Which expects your application to redirect to the url 'https://myapp.example.com/acs?RelayState=...&SAMLResponse=...' with all information as URL parameters.
