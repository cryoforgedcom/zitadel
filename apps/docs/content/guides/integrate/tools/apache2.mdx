---
title: Apache 2.0
description: "Configure OpenID Connect with Apache 2.0 and Zitadel using modauthopenidc to secure routes and handle logout requests"
---
...
![](../../../../public/img/guides/integrate/tools/apache-configuration.png)
![](../../../../public/img/guides/integrate/tools/apache-redirect_settings.png)

You can find the url to your discovery endpoint under "URLs":
![](../../../../public/img/guides/integrate/tools/apache-urls.png)
