...
![Create app in management console](../../../public/img/integrations/mongodb-charts-app-create-light.png)
...
![](../../../public/img/integrations/mongodb-charts-auth-provider-light.png)
