...
description: "Create and manage multiple Zitadel instances for dev, test, and production environments in the Customer Portal."
...
![Select Instance](../../../../public/img/manuals/portal/customer_portal_select_instance.png)
...
![Verify Custom Domain](../../../../public/img/manuals/portal/customer_portal_verify_domain.png)
...
> **_Please note:_** Do not delete the verification code, as Zitadel Customer Portal will re-check the ownership of your domain periodically.
