---
title: User Metadata
description: "Retrieve user metadata using tokens by requesting from Zitadel's userinfo endpoint, ID token, or authentication API with required scopes"
---
...
![](../../../../public/img/console_projects_application_token_settings.png)
...
## Manage user metadata through the API
