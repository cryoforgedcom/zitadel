...
description: "Strategy for migrating between Zitadel instances, including data export and import using service accounts."
...
2. Create a service account "import_user" with Access Token Type "Bearer"
3. Create a [personal access token](/guides/integrate/service-accounts/personal-access-token)
4. Go to the Default settings
5. Add the import_user as [manager](/guides/manage/console/administrators) with the role "instance Owner"
...
1. Go to your default organization
2. Create a service account "export_user" with Access Token Type "Bearer"
3. Create a [personal access token](/guides/integrate/service-accounts/personal-access-token)
4. Go to the Default settings
5. Add the export_user as [manager](/guides/manage/console/administrators) with the role "instance Owner"
