...
description: "Build secure and scalable B2C applications with Zitadel, covering user registration and branding."
sidebar_label: B2C
---
...
<img src="/docs/img/guides/branding.jpeg" alt="branding in management console"/>
</Column>
