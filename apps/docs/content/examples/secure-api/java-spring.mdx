...
![Create app in management console](../../../public/img/java-spring/api-create.png)

Select Basic Auth for authenticating at the Introspection Endpoint.

![Create app in management console](../../../public/img/java-spring/api-create-auth.png)
...
![Create api key in management console](../../../public/img/java-spring/api-create-clientid-secret.png)
...
![Create project role in management console](../../../public/img/java-spring/api-project-role.png)
...
![Created role assignment in management console](../../../public/img/java-spring/api-project-auth.png)
