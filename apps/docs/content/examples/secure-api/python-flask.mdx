...
<ul>
<li> "/img/api/public" - No access token is required.</li>
<li>"/img/api/private" - A valid access token is required.</li>
<li>"/img/api/private-scoped" - A valid access token and a "read:messages" scope are required.</li>
</ul>
