...
![Create app in management console - set auth method](../../../public/img/go/app-create-auth.png)
...
![Create app in management console - set redirectURI](../../../public/img/go/app-create-redirect.png)
...
![Create app in management console - copy client_id](../../../public/img/go/app-create-clientid.png)
