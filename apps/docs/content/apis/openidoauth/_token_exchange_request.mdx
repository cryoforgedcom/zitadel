...
| scope                | [Scopes](/apis/openidoauth/scopes) you would like to request from Zitadel for the requested token. Scopes are space delimited, e.g. `openid email profile`. |
