---
title: Laravel
description: "Integrate Zitadel OAuth 2.0 PKCE with Laravel Socialite to provide secure authentication for your web app."
sidebar_label: Laravel
framework_url: https://laravel.com
auth_library: "Laravel Socialite"
auth_library_url: https://laravel.com/docs/socialite
example_repo: https://github.com/zitadel/example-auth-laravel
auth_flow: pkce
status: stable
---
