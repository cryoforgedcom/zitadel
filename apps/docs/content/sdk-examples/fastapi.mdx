---
title: FastAPI
description: "Integrate Zitadel authentication into FastAPI applications using the OAuth 2.0 PKCE flow."
sidebar_label: FastAPI
framework_url: https://fastapi.tiangolo.com
auth_library: "Authlib"
auth_library_url: https://authlib.org
example_repo: https://github.com/zitadel/example-auth-fastapi
auth_flow: pkce
status: stable
---
