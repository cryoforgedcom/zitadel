---
title: "Self-Hosted Zitadel Configuration: Runtime Settings & Environment Variables"
description: "Complete guide to configuring your self-hosted Zitadel environment using the defaults.yaml runtime file, database initialization steps, and environment variables."
...
import DefaultsYaml from '../../../../../../cmd/defaults.yaml';
import StepsYaml from '../../../../../../cmd/setup/steps.yaml';
import SkipSuperUserQueries from './example-skip-superuser-queries.yaml';
...
<details>
  ...
  <DynamicCodeBlock lang="yaml" code={DefaultsYaml} />
</details>
...
<details>
  ...
  <DynamicCodeBlock lang="yaml" code={StepsYaml} />
</details>
...
<details>
  ...
  <DynamicCodeBlock lang="yaml" code={SkipSuperUserQueries} />
</details>
...
<Tabs
  ...
  defaultIndex={1}
  items={['Linux and Unix','Docker Compose', 'Kubernetes (Helm)']}
>
  <Tab value="Linux and Unix">
    <LinuxUnix components={props.components}  />
    <Login components={props.components} />
  </Tab>
  <Tab value="Docker Compose">
    <Compose components={props.components}  />
    <Login components={props.components} />
  </Tab>
  <Tab value="Kubernetes (Helm)">
    <Helm components={props.components}  />
  </Tab>
</Tabs>
