...
description: "Zitadel's roadmap including upcoming features, release timelines, and planned improvements."
...
<table id="zitadel-versions">
    ...
    <tbody>
        ...
        <tr>
            <th scope="row">[v2.x](/product/roadmap#v2-x)</th>
            <td colSpan={6} className="release-stable">GA / Stable </td>
            <td colSpan={3} className="release-deprecated">Deprecated</td>
            <td colSpan={16}></td>
        </tr>
        <tr>
            <th scope="row">[v3.x](/product/roadmap#v3-x)</th>
            <td colSpan={3} className="release-impl">Implementation</td>
            <td className="release-rc">RC</td>
            <td colSpan={5} className="release-stable">GA / Stable </td>
            <td colSpan={3} className="release-deprecated">Deprecated</td>
            <td colSpan={12}></td>
        </tr>
        <tr>
            <th scope="row">[v4.x](/product/roadmap#v4-x)</th>
            <td colSpan={3}></td>
            <td colSpan={3} className="release-impl">Implementation</td>
            <td className="release-rc">RC</td>
            <td colSpan={5} className="release-stable">GA / Stable </td>
        ...
        <tr>
            <th scope="row">[v5.x](/product/roadmap#v5-x)</th>
            <td colSpan={24}>TBC</td>
        </tr>
    </tbody>
</table>
...
<SDKv3 components={props.components} />
